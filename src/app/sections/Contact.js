            ...
            <form>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="bg-primary-lighttheme dark:bg-primary-darktheme py-3 px-4 block w-full border border-gray-200 dark:border-gray-800 rounded-lg text-sm outline-none focus:border-primary-orange disabled:opacity-50 disabled:pointer-events-none"
              ...
              <div className="mt-4 grid">
                <button
                  type="button"
                  onClick={formHandler}
                  className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-primary-orange text-white hover:opacity-95 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                >
                  Send inquiry
                </button>
              </div>
